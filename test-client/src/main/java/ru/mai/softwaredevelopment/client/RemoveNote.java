...
public class RemoveNote extends Application {
    private Label label;
    private VBox vBox;
    ...
    public void start(Stage stage) throws IOException {
        ...
        button.setOnMouseClicked(mouseEvent -> {
            try {
                ...
                String requestBody = "{\"sessionKey\": \"" + sessionKey.getText() + "\", \"username\": \"" + username.getText() + "\", \"date\": \"" + date.getText() + "\"}";
